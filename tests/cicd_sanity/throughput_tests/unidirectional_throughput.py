...
def main(ap_model, firmware, radio, ssid_name, ssid_psk, security, station, runtime, lanforge_ip, upstream_port):
    ######## Establish Client Connection #########################
    singleClient = SingleClient(lanforge_ip, 8080, debug_=False)
...
def eap_tput(sta_list, ssid_name, radio, security, eap_type, identity, ttls_password, lanforge_ip, upstream_port):
    eap_connect = SingleClientEAP(lanforge_ip, 8080, _debug_on=False)
